...
public class RelationalDataAccessApplication implements CommandLineRunner {
    ...
    private static final Logger log = org.slf4j.LoggerFactory.getLogger(RelationalDataAccessApplication.class);
    ...
    public void run(String... args) throws Exception {
        ...
        //split up the array of whole names into first and last names
        ...
        // uses JdbcTemplate's batchUpdate operation to bulk load the data
        jdbcTemplate.batchUpdate("INSERT INTO customers (first_name, last_name) VALUES (?, ?)", splitUpNames);
        log.info("Querying for customer records where first name is either 'Josh' ");
